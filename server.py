...
import psycopg2
import os
import requests  # Added for Roblox API
...
ROBLOX_COOKIE = os.getenv("ROBLOX_COOKIE", "")
...
policeRanks = [
    ("99365640", 1),  # Militiaman
    ("100026044", 2), # SM
    ("100026045", 7), # SL
    ("100026046", 15), # Starshina
    ("100026047", 35), # JL
    ("100026053", 50), # Lieutenant
    ("107041293", 70), # SL
    ("100026067", 80) # Captain
]
...
def update_player(userId, politicalPower, militaryExperience, policeAuthority, todayPlayTime, cycleIndex, timeLastCheck, timeLastReset, addType, pointMultiplier):
    ...
    if addType == "general":
        return jsonify({"politicalPower": politicalPower, "militaryExperience": militaryExperience, "policeAuthority": policeAuthority,
                        "todayPlayTime": todayPlayTime, "cycleIndex": cycleIndex, "pointMultiplier": pointMultiplier})
    
    # Determine rank and threshold based on addType
    if addType == "party":
        rankInfo = get_partyRanks(politicalPower)
        points = politicalPower
        group = "party"
    elif addType == "military":
        rankInfo = get_militaryRanks(militaryExperience)
        points = militaryExperience
        group = "military"
    elif addType == "police":
        rankInfo = get_policeRanks(policeAuthority)
        points = policeAuthority
        group = "police"
    else:
        return jsonify({"error": "Invalid addType"}), 400

    rankThreshold = rankInfo["threshold"]
    # Promote if points just crossed the threshold (within pointMultiplier)
    if 0 <= points - rankThreshold < pointMultiplier:
        update_roblox_rank(userId, rankInfo["rank"], group)

    return jsonify({"politicalPower": politicalPower, "militaryExperience": militaryExperience, "policeAuthority": policeAuthority,
                    "todayPlayTime": todayPlayTime, "cycleIndex": cycleIndex, "pointMultiplier": pointMultiplier,
                    "rankId": rankInfo["rank"], "rankThreshold": rankThreshold})
